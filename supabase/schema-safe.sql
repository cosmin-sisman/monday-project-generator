-- Monday Project Generator Database Schema (SAFE VERSION)
...
-- Index pentru performanta (DROP IF EXISTS not needed, CREATE INDEX IF NOT EXISTS handles it)
...
-- Trigger pentru updated_at (recreate after dropping)
