          ...
          <div className="max-w-3xl space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center">
                  <svg className="w-8 h-8" viewBox="0 0 24 24" fill="#6161FF">
                    <path d="M0 0h24v24H0z" fill="none"/>
                    <path d="M3 3h18v18H3z"/>
                  </svg>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Monday.com</h3>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">AI-powered project generation</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle2 className="h-5 w-5 text-green-600" />
            ...
            <div className="bg-white rounded-lg shadow-md p-6 flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Database and storage</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle2 className="h-5 w-5 text-green-600" />
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-600">
                All integrations are configured and operational. API keys are managed
